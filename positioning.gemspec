...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "bigdecimal", "~> 1.4.0" # Added to avoid error running tests
  ...
  spec.add_development_dependency "pg", "< 1.0" # Decreased to enable compatibility
